...
Dengan menggunakan menu "Remote-SSH: Connect to Host..." \ref{fig:remote-sshmenu} (Ctrl+Shift+P) atau bisa juga meng-klik icon seperti "><" di pokok kiri bawah VS Code \ref{fig:kiribawah}, saya memasukkan alamat IP server VPS dan nama pengguna yang sesuai. Setelah berhasil terhubung, Visual Studio Code akan membuka direktori root dari server VPS.
