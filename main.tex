...
\begin{enumerate}[label=\Alph*., leftmargin=*, itemsep=2.0em]
  \item \phantomsection\addcontentsline{toc}{section}{\Alph{enumi}. Tujuan Percobaan}\textbf{Tujuan Percobaan}
  \begin{enumerate}[label=\arabic*., leftmargin=2.0em]
    \item 
    \item 
  \end{enumerate}

  \item \phantomsection\addcontentsline{toc}{section}{\Alph{enumi}. Dasar Teori}\textbf{Dasar Teori}
  {\color{red}(Silakan anda tambahkan teori terkait percobaan unit ini dan cantumkan sumber referensinya
  pada bagian daftar pustaka.)}

  \item \phantomsection\addcontentsline{toc}{section}{\Alph{enumi}. Hasil dan Pembahasan}\textbf{Hasil dan Pembahasan}

  \item \phantomsection\addcontentsline{toc}{section}{\Alph{enumi}. Kesimpulan}\textbf{Kesimpulan}

  \item \phantomsection\addcontentsline{toc}{section}{\Alph{enumi}. Daftar Pustaka}\textbf{Daftar Pustaka}
  \nocite{*}
