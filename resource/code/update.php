...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    ...
    <?php
    $id = $_GET['id_mhs'];
    // URL API untuk GET data spesifik
    $api_url = 'http://103.139.192.46/a1/6/sait_api/mahasiswa_api.php?id_mhs=' . $id;
    ...
    <div class="w-full max-w-md bg-white shadow-lg rounded-lg p-8">
        ...
        if (isset($_POST['submit'])) {
            ...
            $update_url = 'http://103.139.192.46/a1/6/sait_api/mahasiswa_api.php?id_mhs=' . $id;
